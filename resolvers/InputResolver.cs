...
{
    private readonly static ILogger log = LoggingUtils.getLoggerFactory().CreateLogger<InputResolver>();
    

    public static processor.ActionProcessor resolve(string action)
{
    switch (action)
    {
        ...
        default:
            ...
            log.LogError(
                ...
                "4-invoice-sign: to sign Invoice\n" +
